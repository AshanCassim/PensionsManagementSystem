...
<div class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card">
                        <div class="header">
                                <h4 class="title">Applications Pending Your Approval</h4>
                        </div>
                    ...
                    <table id="pending" class="table table-striped">
                           ...
                           <?php
                                            foreach ($pendinglist as $row){
                                                ...
                                                echo '</td>';
                                                echo '<td>';
                                                echo '<span> <i class="ti-eye"></i><a href="'.base_url().'quartermaster/view/'.$row['nic'].'"></span>    View</a> ' ;
                                                if($row['status']==3){
                                                    echo '<br><div style="width:200px;"class="alert alert-danger" ><i class="ti-infinite"></i> Revision Pending</div>';
                                                };
