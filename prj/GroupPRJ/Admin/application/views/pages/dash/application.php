...
foreach  ($data as $i){
    ...
    echo '<button id="BTN-'.$i['id'].'" onclick=validate("'.$i['name'].'") ><i class="ti-close"></i></button>';
    echo '<br>';
}
?>
...
<?php echo '<button id="BTN-Residential_Address" onclick=validate("Residential_Address") ><i class="ti-close"></i></button>';?><br>
<!--Upto This Point-->
...
echo '<button id="BTN-MaritalStat" onclick=validate("MaritalStat") ><i class="ti-close"></i></button><br>';
foreach ($data as $i){
...
echo '<button id = "BTN-service" onclick=validate("service") ><i class="ti-close"></i></button><br>';
foreach ($data as $i){
    if ($i['value'] == $service){
        $i=array_merge($i,array('checked'=>'true'));
        // print_r($i);
...
<?php  echo '<button id="BTN-Official_Address" onclick=validate("Official_Address") ><i class="ti-close"></i></button>';?><br>
