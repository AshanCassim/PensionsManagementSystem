...
<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
  <div class="mdl-tabs__tab-bar navmenu" >
      ...
      <a  id= "app_tab" href="#application-panel" class=" mdl-tabs__tab is-active"><span>Application
...
<div class="mdl-tabs__panel" id="lannisters-panel">
    ...
    <ul>
    <li>Application Status:<span class="mdl-chip">
    <span class="mdl-chip__text">
    <?php print_r(getstatus($status['status']))//Echo the Status of the Application?></span></span></li>
    
    <li>Pensions Personal File Status:</li>
    <li>Pensions and Gratuities Particulars
        <ul>
            <li>Estimated Calculated Amount (Pension)</li>
            <li>Estimated Calculated Amount (Gratuities): <?php echo $Gratuity?></li>
    ...
    <li>Payment Details
        <ul>
            ...
            <li>Bank and Branch:<span class="mdl-chip"><span class="mdl-chip__text"><?php echo $Bank_branch;?></span></span> </li> 
